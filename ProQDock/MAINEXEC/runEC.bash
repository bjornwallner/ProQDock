...
cp $pdbinp orig.pdb
NO=`$path/MAINEXEC/pdb2resWMchain.pl orig.pdb`
#wc -l orig.res
...
cp $pdb1 inp1map.pdb
N1=`$path/MAINEXEC/pdb2resWMchain.pl inp1map.pdb`
echo "$pdb1 CONTAINS $N1 RESIDUES"
cp $pdb2 inp2map.pdb
N2=`$path/MAINEXEC/pdb2resWMchain.pl inp2map.pdb`
echo "$pdb2 CONTAINS $N2 RESIDUES"
cp $pdb12 inp12map.pdb
N3=`$path/MAINEXEC/pdb2resWMchain.pl inp12map.pdb`
...
$path/MAINEXEC/pdb2resWMchain.pl $pdb1
$path/MAINEXEC/pdb2resWMchain.pl $pdb2
