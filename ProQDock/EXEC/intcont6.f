...
!=========================================================================================================
                ...
                icontmat(j1,i1) = icontmat(j1,i1) + 1
                 ...
                 write(31,197)res1(i),res2(j),icnt,i1,j1,'----','-----'
                 elseif (idiag == 1 .and. idiag2 == 0)then
                 write(31,197)res1(i),res2(j),icnt,i1,j1,'DIAG','-----'
                 elseif (idiag == 0 .and. idiag2 == 1)then
                 write(31,197)res1(i),res2(j),icnt,i1,j1,'----','GDIAG'
                 elseif (idiag == 1 .and. idiag2 == 1)then
                 write(31,197)res1(i),res2(j),icnt,i1,j1,'DIAG','GDIAG'
                 endif
                endif
           enddo
      enddo
